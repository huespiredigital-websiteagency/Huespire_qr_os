...
export class UpdatePlanDto {
  @ApiProperty({ description: "Plan Name", example: "Starter", required: false })
  @IsOptional()
  @IsString()
  @MinLength(2)
  @MaxLength(100)
  ...
  @ApiProperty({ description: "Plan Code", example: "STARTER", required: false })
  @IsOptional()
  @IsString()
  @MinLength(2)
  code?: string;
  ...
  @ApiProperty({ description: "One-time Setup Fee", example: 18000.00, required: false })
  @IsOptional()
  @IsNumber({ allowInfinity: false, allowNaN: false })
  @Min(0)
  setupFee?: number;

  @ApiProperty({ description: "Monthly Price", example: 1000.00, required: false })
  @IsOptional()
  @IsNumber({ allowInfinity: false, allowNaN: false })
  @Min(0)
  monthlyPrice?: number;

  @ApiProperty({ description: "Maximum Tables allowed", example: 20, required: false })
  @IsOptional()
  @IsNumber({ allowInfinity: false, allowNaN: false })
  @Min(1)
  maxTables?: number;
  ...
  @ApiProperty({ description: "Monthly Email limit", example: 1000, required: false })
  @IsOptional()
  @IsNumber({ allowInfinity: false, allowNaN: false })
  @Min(0)
  ...
  @ApiProperty({ description: "Plan active status", example: true, required: false })
  @IsOptional()
  @IsBoolean()
  isActive?: boolean;

  @ApiProperty({ description: "UI Display Order", example: 1, required: false })
  @IsOptional()
  @IsNumber()
  displayOrder?: number;
}